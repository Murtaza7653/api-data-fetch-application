...
export default class UsersTemp extends Component {
    ...
    render() {
        return (
            <div className='container my-3'>
                ...
                <button className="btn btn-outline-dark my-2" type="submit" onClick={this.loadUsers} >{!(this.state.display) ? "Get Users" : "Refresh" }</button>
                </div>
